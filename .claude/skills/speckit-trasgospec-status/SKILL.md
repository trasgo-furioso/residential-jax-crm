---
name: speckit-trasgospec-status
description: Set, validate, or revert lifecycle status on a feature.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: trasgospec:commands/speckit.trasgospec.status.md
---
...
2. Run `.specify/extensions/trasgospec/scripts/bash/status-change.sh <action> [args...]` from the repo root and parse the JSON output.
